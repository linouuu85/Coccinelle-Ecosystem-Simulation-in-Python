...
#############################################################################
coc1= Coccinelle("Femelle", 10 , 2)
coc2= Coccinelle("Femelle", 10 , 2)
coc3= Coccinelle("Mâle", 10 , 2)
# Création de la liste de population et du nombre de pucerons
population_initial = [coc1,coc2,coc3]
p = 200
for i in range(5):
    population_initial, p=evolution(population_initial,p)
    print(f"Jour{i+1} : {len(population_initial)} coccinelles, {p} pucerons")